...
public class RoomCreator 
{
	...
	public static ArrayList<Room> rooms()
	{
		...
		r.add(new Room("Lich's Lair", "Your in the Lich's Lair", true));
		...
		r.add(new Room("Coin Puzzle Room", "Your in the coin puzzle room", false));
		...
		r.add(new Room("Ogre's Lair", "Your in the Ogre's Lair", true));
		...
		r.add(new Room("Jester's Lair", "Your in the Jester's Lair", true));
